const n=`\`useCallback\` is a React Hook that returns a **memoized version of a callback function**, so that the function **only changes if its dependencies change**.
...
- \`useCallback\`: Memoizes **function**.`;export{n as default};
